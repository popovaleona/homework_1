...
public class SerializersTest {
    ...
    public void serializeObjectTwoLists() throws IOException, ClassNotFoundException {
        ...
        animalList1.add(new Animal("tiger", TypeOfAnimals.WILD, 5,
                Arrays.asList(new Food("meat", 2))));
        animalList1.add(new Animal("Horse", TypeOfAnimals.HOME, 7,
                Arrays.asList(new Food("Oat", 15))));
        animalList1.add(new Animal("Snake", TypeOfAnimals.WILD, 5,
                Arrays.asList(new Food("mouse", 1))));
        List<Animal> animalList2 = new ArrayList<Animal>();
        animalList2.add(new Animal("Fox", TypeOfAnimals.WILD, 8,
                Arrays.asList(new Food("cereal", 10))));
        animalList2.add(new Animal("Zebra", TypeOfAnimals.HOME, 1,
                Arrays.asList(new Food("Bug", 15))));
        animalList2.add(new Animal("Rabbit", TypeOfAnimals.WILD, 2,
                Arrays.asList(new Food("Bug", 15))));
